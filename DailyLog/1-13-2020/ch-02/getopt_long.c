...
/* Prints usage info for this program to STREAM (typically
   stdout or stderr), and exit the program with EXIT_CODE. Does
   not return. */
...
/* Main program entry point. ARGC contains number of argument list
   elements; AARGV is an array of pointers to them. */
...
/* The name of the file to recieve program output, or NULL for
   standard output. */
